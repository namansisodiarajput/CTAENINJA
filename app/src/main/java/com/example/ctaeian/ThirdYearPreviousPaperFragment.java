...
public class ThirdYearPreviousPaperFragment extends Fragment {
    ...
    public ThirdYearPreviousPaperFragment() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Third Year Previous Year Papers");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_third_year_previous_paper, container, false);
