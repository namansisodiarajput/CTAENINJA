...
public class ResultFirstYearFragment extends Fragment {
    ...
    public ResultFirstYearFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_result_first_year, container, false);
        FIRST_YEAR_SECTIONA = (Button) view.findViewById(R.id.FIRST_YEAR_RESULT_SECTIONA);
        FIRST_YEAR_SECTIONB = (Button) view.findViewById(R.id.FIRST_YEAR_RESULT_SECTIONB);
