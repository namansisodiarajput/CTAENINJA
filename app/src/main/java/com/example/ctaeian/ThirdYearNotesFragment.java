...
public class ThirdYearNotesFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Third Year Notes");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_third_year_notes, container, false);
